    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default form-group" style="padding:30px;">
                    <form action='/tasks/<?php echo e($task->id); ?>'  method="POST" class="form-group">
                    <input type="hidden" value="<?php echo e($task->urgency); ?>" id="oldU">
                    <input type="hidden" value="<?php echo e($task->color); ?>" id="oldC">
                    <input type="hidden" value="PUT" name="_method" id="oldC">
                    <?php echo e(csrf_field()); ?>

                    <h1>Update your taks</h1><br>
                    <div class="from-group">
                         <input class="form-control" style="width:96%;" placeholder="Your To Do Task Here..." value="<?php echo e($task->task); ?>" type="text" name="task">     
                    </div>
                    <br>    
